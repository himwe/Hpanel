...
src_url=http://www.php.net/distributions/php-5.5.22.tar.gz && Download_src
...
patch -d php-5.5.22 -p0 < fpm-race-condition.patch
cd php-5.5.22
make clean
