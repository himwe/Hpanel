...
do
	echo
	read -p "Please input domain(example: www.himwe.com): " domain
...
if [ "$moredomainame_yn" == 'y' ]; then
        ...
        do
                echo
                read -p "Type domainname,example(himwe.com www.example.com): " moredomain
